...
namespace Utilities
{
	public class CustomCamera : MonoBehaviour {
		...
		void LateUpdate () {
			...
			Debug.Log($"I THINK the bug is here. {current_cam}");
			...
			Debug.Log("What about the potential bug being down here.");
			...
			Debug.Log("I think the potential bug might be down here!");
