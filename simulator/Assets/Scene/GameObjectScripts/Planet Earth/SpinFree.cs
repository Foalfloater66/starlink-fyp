...
namespace Scene.GameObjectScripts.Planet_Earth
{
    /// <summary>
    ...
    public class SpinFree : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            for (var i = 0; i < 32; i++)
            {
                ...
                var scale = orbits[count].transform.localScale;
                scale.x *= 1.181f;
                scale.y *= 1.181f;
                scale.z *= 1.181f;
                ...
                for (var s = 0; s < 50; s++)
                {
                    ...
                    pos.x += 4f;
                    var sat1 = (GameObject)Instantiate(satellite, pos, transform.rotation);
            ...
            for (var i = 0; i < 32; i++)
            {
                ...
                orbitaxes[count] = Quaternion.Euler(0, 5.625f + i * 11.25f, 0) *
                                   (Quaternion.Euler(0, 0, 53.8f) * Vector3.up);
                var scale = orbits[count].transform.localScale;
                scale.x *= 1.174f;
                scale.y *= 1.174f;
                scale.z *= 1.174f;
            ...
            for (var i = 0; i < 8; i++)
            {
                ...
                orbitaxes[count] = Quaternion.Euler(0, 3.3105f + i * 45f, 0) *
                                   (Quaternion.Euler(0, 0, 74) * Vector3.up);
                var scale = orbits[count].transform.localScale;
                scale.x *= 1.174f;
                scale.y *= 1.174f;
                scale.z *= 1.174f;
            ...
            for (var i = 0; i < 5; i++)
            {
                ...
                orbitaxes[count] = Quaternion.Euler(0, 3.3105f + 17f + i * 75f, 0) *
                                   (Quaternion.Euler(0, 0, 81) * Vector3.up);
                var scale = orbits[count].transform.localScale;
                scale.x *= 1.174f;
                scale.y *= 1.174f;
                scale.z *= 1.174f;
            ...
            for (var i = 0; i < 6; i++)
            {
                ...
                orbitaxes[count] = Quaternion.Euler(0, 3.3105f + 43f + i * 60f, 0) *
                                   (Quaternion.Euler(0, 0, 70) * Vector3.up);
                var scale = orbits[count].transform.localScale;
                scale.x *= 1.174f;
                scale.y *= 1.174f;
                scale.z *= 1.174f;
