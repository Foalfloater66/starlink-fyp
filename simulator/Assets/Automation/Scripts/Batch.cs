        ...
        public static void Run(string[] args)
        {
            ...
            foreach (Experiment experiment in specification.experiments)
            {
                for (int id = 0; id < experiment.reps; id++)
                {
                    ...
                    clone.Build(id, specification.frames, specification.logScreenshots, specification.logVideo,
                        specification.logAttack, specification.logRTT, specification.logHops);
