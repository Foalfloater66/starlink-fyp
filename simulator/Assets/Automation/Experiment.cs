...
namespace Automation
{
    ...
    public class Experiment
    {
        ...
        [NonSerialized] public bool LogScreenshots;
        [NonSerialized] public bool LogVideo;
        [NonSerialized] public bool LogAttack;
        [NonSerialized] public bool LogRTT;
        ...
        public void Build(int id, int frames, bool logScreenshots, bool logVideo, bool logAttack, bool logRTT,
            bool logHops)
        {
            reps = 1;
            Frames = frames;
        ...
        {
            return new Experiment(choice, direction, rMax, ID, Frames, LogScreenshots, LogVideo, LogAttack, LogRTT,
                LogHops);
        }
    }
}