...
namespace Orbits
{
    public class Constellation
    {
        ...
        public Constellation(Transform transform, GameObject orbit, GameObject satellite, GameObject beam_prefab,
            GameObject beam_prefab2, GameObject laser, GameObject thinLaser, float speed, bool use_isls)
        {
